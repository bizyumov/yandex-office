#!/usr/bin/env python3
"""Tests for yandex-telemost processor.
...
# Post-enrichment meta (as produced by enrich_incoming + yandex-mail)
SUMMARY_META = {
    "imap_uid": 2550,
    "mailbox": "test",
...
def test_full_merge():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert meta["video_url"] == "https://yadi.sk/d/abc123_video"
        assert meta["audio_url"] == "https://yadi.sk/d/def456_audio"
...
def test_existing_meta_non_destructive_merge():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        meeting_data_recording = {
            ...
            "summary": None,
            "telemost_summary": None,
            "video_url": "https://yadi.sk/d/abc123_video",
            "audio_url": "https://yadi.sk/d/def456_audio",
            "media_links": [
                "https://yadi.sk/d/abc123_video",
                "https://yadi.sk/d/def456_audio",
            ],
