...
#   */30 * * * * /path/to/yandex-telemost/scripts/process.sh
#
...
# PID file lock
PIDFILE="/tmp/yandex-telemost-process.pid"
...
if [ ! -f "$CONFIG_PATH" ]; then
    ...
    echo "Set YANDEX_TELEMOST_CONFIG or place config.json in yandex-skills root."
    exit 1
fi
